...
public interface IEstadisticaService {
    List<ModeloEstadisticaDTO> getCantidadOrdenesDeModelos(Date fechaInicio, Date fechaFin, Integer tecnico);

    List<EstadosEstadisticaDTO> getCantidadOrdenesDeEstados(Date fechaInicio, Date fechaFin, Integer tecnico);

    List<TecnicosEstadisticaDTO> getPromediosTecnicos(Date fechaInicio, Date fechaFin);

    List<GananciasMensualesDTO> getGananciasMensuales(Date fechaInicio, Date fechaFin, Integer tecnico);
}
