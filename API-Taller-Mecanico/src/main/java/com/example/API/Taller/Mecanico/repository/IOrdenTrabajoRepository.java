...
public interface IOrdenTrabajoRepository extends JpaRepository<OrdenTrabajo, Integer> {
    ...
    void actualizarOrden(@Param("ordenId") Integer ordenId, @Param("fechaInicio") Date fechaInicio, @Param("fechaFin") Date fechaFin, @Param("estado") Estado estado, @Param("comentario") String comentario, @Param("cliente") Cliente cliente, @Param("vehiculo") Vehiculo vehiculo, @Param("tecnico") Tecnico tecnico);
