...
public interface IOrdenTrabajoRepository extends JpaRepository<OrdenTrabajo, Integer> {
    ...
    void actualizar(@Param("ordenId") Integer odrdenId, @Param("fechaInicio") Date fechaInicio, @Param("fechaFin") Date fechaFin, @Param("vehiculo") Vehiculo vehiculo, @Param("tecnico") Tecnico tecnico, @Param("estado") Estado estado, @Param("comentario") String comentario, @Param("cliente") Cliente cliente);
